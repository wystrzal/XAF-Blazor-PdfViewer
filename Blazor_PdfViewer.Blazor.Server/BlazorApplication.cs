...
using Blazor_PdfViewer.Blazor.Server.Services;

namespace Blazor_PdfViewer.Blazor.Server {
    public partial class Blazor_PdfViewerBlazorApplication : BlazorApplication {
        public Blazor_PdfViewerBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void Blazor_PdfViewerBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
